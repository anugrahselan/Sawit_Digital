...
class Harga_tbs_model extends CI_Model
{
    ...
    public function get_latest_per_company()
    {
    ...
    public function get_all_filtered($filters = [], $limit = null, $offset = null)
    {
        $this->db->select('harga_tbs.*, kabupaten.nama_kabupaten, perusahaan.nama_perusahaan');
        $this->db->from('harga_tbs');
        $this->db->join('kabupaten', 'kabupaten.id_kabupaten = harga_tbs.id_kabupaten', 'left');
    ...
    public function count_all_filtered($filters = [])
    {
        $this->db->from('harga_tbs');
     ...
     */
    public function delete_yesterday_data($id_kabupaten, $id_perusahaan, $current_date, $deleted_by = null)
    {
     ...
     * Backup data sebelum dihapus
     */
    public function backup_before_delete($id, $deleted_by = null)
    {
