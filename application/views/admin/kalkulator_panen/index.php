                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <input type="text" id="searchInput" class="form-control" placeholder="Cari username, perusahaan, harga, berat, atau hasil bersih...">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                            ...
                            <?php if (!empty($kalkulasi)): ?>
                                <div class="riwayat-table-wrapper">
                                    <table class="riwayat-table">
                                        ...
                                        <tbody>
                                            <?php $index = 0; foreach ($kalkulasi as $k): ?>
                                                <?php 
                                                ...
                                                <tr class="riwayat-row" data-id="<?= $uniqueId ?>">
                                                    ...
                                                    <td style="text-align: center;"><?= htmlspecialchars($k->nama_perusahaan ?: '-') ?></td>
                                                    <td style="text-align: center;">Rp <?= number_format($k->harga_per_kg, 0, ',', '.') ?></td>
                                                    <td style="text-align: center;"><?= number_format($k->berat_kotor, 2) ?> kg</td>
                                                    <td style="text-align: center;">
                                                        <strong>
                                                            <?php 
                                                        ...
                                                        <div class="detail-content">
                                                            <div class="detail-grid">
                                                                <div class="detail-item">
                                                                    ...
                                                                    <div class="detail-value"><?= $k->id_kalkulasi ?? '-' ?></div>
                                                                </div>
                                                                <div class="detail-item">
                                                                    <span class="detail-label">Kabupaten:</span>
                                                                    <div class="detail-value"><?= htmlspecialchars($k->nama_kabupaten ?: '-') ?></div>
                                                                </div>
                                                                <div class="detail-item">
                                                                    <span class="detail-label">Potongan:</span>
                                                                    <div class="detail-value"><?= number_format($k->potongan, 2) ?>%</div>
                                                                </div>
                                                                <div class="detail-item">
                                                                    <span class="detail-label">Upah Panen:</span>
                                                                    <div class="detail-value">Rp <?= number_format($k->upah_panen, 0, ',', '.') ?></div>
                                                                </div>
                                                                <div class="detail-item">
                                                                    <span class="detail-label">Biaya Transportasi:</span>
                                                                    <div class="detail-value">Rp <?= number_format($k->biaya_transportasi, 0, ',', '.') ?></div>
                                                                </div>
                                                                <div class="detail-item">
                                                                    <span class="detail-label">Potong Hutang:</span>
                                                                    <div class="detail-value">Rp <?= number_format($k->potong_hutang, 0, ',', '.') ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
