                            ...
                            <p class="card-text">
                                ...
                                <form method="post">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nama_perusahaan" id="nama_perusahaan" value="<?= set_value('nama_perusahaan') ?>" aria-describedby="Nama perusahaan">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control"><?= set_value('alamat') ?></textarea>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="kontak" class="form-label">Kontak</label>
                                        <input type="text" class="form-control" name="kontak" id="kontak" value="<?= set_value('kontak') ?>" aria-describedby="Kontak">
                                    </div>
                                    
                                    <button type="submit" class="btn btn-primary">Tambah</button>
                                    <a href="<?= base_url('admin/perusahaan') ?>" class="btn btn-danger">Kembali</a>
                                </form>
                            </p>
                        </div>
                    </div>
