                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="<?= base_url(uri: 'admin/perusahaan/tambah') ?>" class="btn btn-primary">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <input type="text" id="searchInput" class="form-control"
                                                placeholder="Cari perusahaan, kabupaten, alamat, atau kontak...">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                            ...
                            <?php else: ?>
                                <div class="empty-state">
                                    ...
                                    <p>Anda belum menambahkan data perusahaan. Klik tombol "Tambah Data" untuk menambahkan
                                        data baru.</p>
                                    <a href="<?= base_url(uri: 'admin/perusahaan/tambah') ?>" class="btn btn-primary">Tambah
                                        Data</a>
                                </div>
                            <?php endif; ?>
                        </div>
