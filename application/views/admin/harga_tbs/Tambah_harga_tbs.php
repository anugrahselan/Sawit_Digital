                            ...
                            <p class="card-text">
                                ...
                                <form method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="id_perusahaan" id="id_perusahaan" disabled>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="harga_per_kg" id="harga_per_kg" value="<?= set_value('harga_per_kg') ?>" step="0.01" min="0" aria-describedby="Harga per kg">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadPerusahaan(id_kabupaten) {
        if (!id_kabupaten) {
            perusahaanSelect.innerHTML = '<option value="">Pilih Kabupaten terlebih dahulu</option>';
