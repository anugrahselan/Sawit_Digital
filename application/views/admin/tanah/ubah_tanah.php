            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/tanah') ?>">Tanah</a></li>
                                ...
                                <form method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="ph_min" id="ph_min" value="<?= set_value('ph_min', $tanah->ph_min) ?>" step="0.1" min="0" max="14" placeholder="Contoh: 5.5">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="kandungan_n" id="kandungan_n" value="<?= set_value('kandungan_n', $tanah->kandungan_n) ?>" step="0.01" min="0" placeholder="Contoh: 2.5">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="kandungan_p" class="form-label">Kandungan P (%)</label>
                                            <input type="number" class="form-control" name="kandungan_p" id="kandungan_p" value="<?= set_value('kandungan_p', $tanah->kandungan_p) ?>" step="0.01" min="0" placeholder="Contoh: 1.5">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                    ...
                                    <a href="<?= base_url('admin/tanah') ?>" class="btn btn-danger">Kembali</a>
                                </form>
                            </p>
                        </div>
                    </div>
