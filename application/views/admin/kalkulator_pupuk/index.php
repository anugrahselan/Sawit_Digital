                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="card-title">Daftar Kalkulasi Pupuk</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <input type="text" id="searchInput" class="form-control" placeholder="Cari username, usia tanaman, jumlah pohon, atau dosis...">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <table class="riwayat-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">USIA TANAMAN</th>
                                                <th style="text-align: center;">JUMLAH POHON</th>
                                                <th style="text-align: center;">DOSIS PER POHON</th>
                                                <th style="text-align: center;">TOTAL DOSIS</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $index = 0; foreach ($dosis as $d): ?>
                                                <?php 
                                                $uniqueId = !empty($d->id_kalkulasi) ? $d->id_kalkulasi : 'pupuk-' . $index;
                                                $targetId = 'detail-pupuk-' . $uniqueId;
                                                ?>
                                                <tr class="riwayat-row" data-id="<?= $uniqueId ?>">
                                                    ...
                                                    <td style="text-align: center;"><?= $d->usia_tanaman ?> bulan</td>
                                                    <td style="text-align: center;"><?= number_format($d->jumlah_pohon, 0) ?></td>
                                                    <td style="text-align: center;"><strong><?= number_format($d->dosis_per_pohon, 2) ?> kg</strong></td>
                                                    <td style="text-align: center;"><strong><?= number_format($d->total_dosis, 2) ?> kg</strong></td>
                                                </tr>
                                                        ...
                                                        <div class="detail-content">
                                                            <div class="detail-grid">
                                                                <div class="detail-item">
                                                                    ...
                                                                    <div class="detail-value"><?= $d->id_kalkulasi ?? '-' ?></div>
                                                                </div>
                                                                <div class="detail-item">
                                                                    <span class="detail-label">Jenis Pupuk:</span>
                                                                    <div class="detail-value"><?= htmlspecialchars($d->nama_pupuk ?: 'ID: ' . $d->id_pupuk) ?></div>
                                                                </div>
                                                                <div class="detail-item">
                                                                    <span class="detail-label">Jenis Tanah:</span>
                                                                    <div class="detail-value"><?= htmlspecialchars($d->nama_tanah ?: 'ID: ' . $d->id_tanah) ?></div>
                                                                </div>
                                                                <div class="detail-item">
                                                                    <span class="detail-label">Periode per Tahun:</span>
                                                                    <div class="detail-value"><?= $d->periode_per_tahun ?>x</div>
                                                                </div>
                                                                <div class="detail-item">
                                                                    <span class="detail-label">Tanggal Kalkulasi:</span>
                            ...
                            <?php else: ?>
                                <div class="empty-state">
                                    ...
                                    <h3>Belum Ada Data Kalkulasi Pupuk</h3>
                                    <p>Belum ada data kalkulasi pupuk yang tersimpan.</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
